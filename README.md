...
**Claude was used solely for .md formats, .sh scripts, verification, syntax error surfing/cleanup, and git push automation**
...
How the pieces talk to each other once boot finishes — supervision on the
left, the files and sockets that carry state between them on the right.
